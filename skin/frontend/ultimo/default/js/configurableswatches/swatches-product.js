...
//            }.bind(this));
    ...
    getOptionLabel: function(option) {
        ...
        /***************************
         * updated to add product SKU
         * removed product proce differential
         ***************************/
        //return option.productSku + ' ' + this.productConfig.getOptionLabel(option, option.price); 

        return option.productSku + ' ' + this.productConfig.getOptionLabel(option); 
    },
