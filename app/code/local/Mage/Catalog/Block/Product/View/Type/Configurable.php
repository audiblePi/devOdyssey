...
class Mage_Catalog_Block_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Abstract
{
    ...
    public function getJsonConfig()
    {
        ...
        /*Build an array of associated product skus*/
        $sku = array();
        if($currentProduct->getTypeId() == "configurable"){
            $childProducts = Mage::getModel('catalog/product_type_configurable')->getUsedProducts(null, $currentProduct);;
            foreach($childProducts as $child){
                ...
                //sort($sku);
                #echo('<script>console.log("PHP: '.$sku[0]['child_id'].'");</script>');
            }
        }
            ...
            if (is_array($prices)) {
                ...
                foreach ($prices as $value) {
                    ...
                    for ($x=0; $x < count($sku); $x++){
                        $tmp = $sku[$x]['child_id'];
                        if ($productsIndex[0] == $tmp){
                            $thisSku = $sku[$x]['child_sku'];
                            #echo('<script>console.log("hit'.$thisSku.'");</script>');
                        }
                    }
                    #echo('<script>console.log("'.$thisSku.'");</script>');
                    ...
                    #echo('<script>console.log("PHP: '.$sku[$i].'");</script>');
                    $i++;
                }
            }
            /**
