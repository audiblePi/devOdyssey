...
class MageWorx_CustomOptions_Model_Mysql4_Product_Indexer_Price_Default extends MageWorx_CustomOptions_Model_Mysql4_Product_Indexer_Price_Default_Abstract 
{
    ...
    protected function _applyCustomOption1620() {
        ...
        if ($this->useIdxTable() && (version_compare(Mage::helper('customoptions')->getMagetoVersion(), '1.6.1', '<') || version_compare(Mage::helper('customoptions')->getMagetoVersion(), '1.6.1', '=') && $this->_allowTableChanges)) {
    ...
    protected function _applyCustomOption1510() {
        ...
        if (version_compare(Mage::helper('customoptions')->getMagetoVersion(), '1.4.2', '<') || $this->useIdxTable()) {
