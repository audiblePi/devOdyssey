...
CREATE TABLE IF NOT EXISTS {$this->getTable('shipusa_singleboxes')} (
  ...
  UNIQUE `IDX_flatbox_product_unique` (`flatboxes_id`, `product_id`),
  KEY `FK_shipusa_flatbox_product_entity` (`product_id`),
  CONSTRAINT `FK_shipusa_flatbox_product_entity` FOREIGN KEY (`product_id`) REFERENCES `{$this->getTable('catalog_product_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
