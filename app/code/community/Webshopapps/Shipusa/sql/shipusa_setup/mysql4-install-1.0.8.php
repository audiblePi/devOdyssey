...
CREATE TABLE IF NOT EXISTS {$this->getTable('shipusa_shipboxes')} (
  ...
  KEY `shipusa_shipbox_sku_entity` (`sku`,`length`,`width`,`height`,`weight`,`declared_value`,`quantity`,`num_boxes`),
...
CREATE TABLE IF NOT EXISTS {$this->getTable('shipusa_singleboxes')} (
  ...
  KEY `shipusa_singlebox_sku_entity` (`sku`,`box_id`,`length`,`width`,`height`,`max_box`,`min_qty`,`max_qty`),
  ...
  KEY `shipusa_flatbox_sku_entity` (`sku`,`box_id`,`length`,`width`,`height`,`max_box`,`min_qty`,`max_qty`),
