...
*/
class Webshopapps_Shipusa_Model_Shipping_Carrier_Fedex_Source_Requesttype
{
    ...
    public function getCode($type, $code = '')
    {
        $codes = array(
            ...
            //    'MULTIWEIGHT' => Mage::helper('shipping')->__('Multi-weight'),  // Cant see where this is used so removing
            ),
